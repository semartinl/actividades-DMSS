 ...
 * </p>
 * <ul>
 *   <li>{@link componentes.impl.RootImpl#getConectores <em>Conectores</em>}</li>
 *   <li>{@link componentes.impl.RootImpl#getComponentes <em>Componentes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RootImpl extends MinimalEObjectImpl.Container implements Root {
	...
	protected EClass eStaticClass() {
		return ComponentesPackage.Literals.ROOT;
	}
	...
	public EList<Conector> getConectores() {
		if (conectores == null) {
			conectores = new EObjectContainmentEList<Conector>(Conector.class, this,
					ComponentesPackage.ROOT__CONECTORES);
		}
		return conectores;
	}
	...
	public EList<Componente> getComponentes() {
		if (componentes == null) {
			componentes = new EObjectContainmentEList<Componente>(Componente.class, this,
					ComponentesPackage.ROOT__COMPONENTES);
		}
		return componentes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ComponentesPackage.ROOT__CONECTORES:
			return ((InternalEList<?>) getConectores()).basicRemove(otherEnd, msgs);
		case ComponentesPackage.ROOT__COMPONENTES:
